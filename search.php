<?php get_header(); ?>
	...
	<?php if (have_posts()) : ?>
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<div class="post">
				<h3 id="post-<?php the_ID(); ?>"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php echo get_post_meta($post->ID, "description", true); ?>"><?php the_title(); ?></a>&nbsp;<g:plusone size="small" href="<?php the_permalink() ?>"/></h3>
